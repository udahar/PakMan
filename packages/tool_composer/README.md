...
> **Status:** ALPHA | **Tags:** tools, pipelines, composition, chaining

## Overview
Compose multiple tools into pipelines. Chain tool calls with routing and fallback.
...
```python
import tool_composer
# Integrate tool_composer as needed in your stack.
```
