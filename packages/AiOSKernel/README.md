...
> **Status:** ALPHA | **Tags:** kernel, os, primitives, infrastructure

## Overview
Core kernel for AI operating system primitives â€” process model, memory model, I/O model.
...
```python
import AiOSKernel
# Integrate AiOSKernel as needed in your stack.
```
