...
> **Status:** BETA | **Tags:** safety, review, guard, validation

## Overview
LLM output safety guard. Reviews generated code and content before use.
...
```python
import SafetySentry
# Integrate SafetySentry as needed in your stack.
```
