...
> **Status:** STABLE | **Tags:** prompting, reasoning, scaffolding, skills

## Overview
26 reusable AI reasoning skills and strategy scaffolds. Injected into task briefs automatically.
...
```python
import PromptSKLib
# Integrate PromptSKLib as needed in your stack.
```
